...
```
Most participants shared a picture of a poster they put up, but some expressed their creativity via graffiti, chalk art, or wrote hand-written messages.
...
Mapping the number of posters from early October to mid-November, we can see that:
...
Mapping the number of posters by day of the week, we observe that most events happen on Thursday and Friday, which deviates from the conventional wisdom that protests happen more over the weekend. The increase on Thursday and Friday can partially explained by the increase of posters posted on University campus, pointing to the possibility that most participants of the poster movements are students, who tend to push their "extracurriculars" to Thursdays and Fridays.
